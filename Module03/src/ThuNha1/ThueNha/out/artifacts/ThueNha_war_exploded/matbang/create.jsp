    ...
    <nav>
        <div class="row container">
            <article class="col-sm-3">
                <a class="nav-link " href="/matbang">Xem danh sách nhân viên</a>
                <a class="nav-link " href="/matbang?action=create">Thêm mới nhân viên</a>
            </article>
                ...
                <div class="container">
                    <form method="post" id="create" class="form" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"  name="dientich" class="form-control"  min="20" >
                        </div>
                        <div class="form-group">
                            <label >Tầng:</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"  name="gia" class="form-control"  min="1000000"  >
                        </div>
                        <div class="form-group">

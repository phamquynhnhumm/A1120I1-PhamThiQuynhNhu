...
import TestThi1.Commons.ReadWriteFile;
import TestThi1.Commons.Regex;
...
public class NhapKhauService {
    ...
    private String NHAPKHAU_PATH ="D:\\A112011PhamThiQuynhNhu\\Module02\\src\\FinalExam\\data\\NhapKhau1.csv";
    private List<NhapKhau> nhapKhauList;
    ...
    public List<NhapKhau> getAllNhapKhau(){
        ...
        for(int i =0;i<nhapKhauListLine.length;i++){
            ...
            nhapKhauList.add(new NhapKhau(tTinhNK[0],tTinhNK[1],tTinhNK[2],tTinhNK[3],tTinhNK[4],tTinhNK[5],tTinhNK[6],tTinhNK[7],tTinhNK[8]));
        }
        return nhapKhauList;
    }
    public void view(){
    ...
    public List<NhapKhau> getNhapKhauList(){
        return nhapKhauList;
    }
    public void inputNewNhapKhau(){
        ...
        NhapKhau newNhapKhau = (NhapKhau) commonService.inputSanPham(1);
        String giaNhapKhau;
    ...
    public  void searchNhapKhau(){
        List<NhapKhau> ListResult = new ArrayList<>();
